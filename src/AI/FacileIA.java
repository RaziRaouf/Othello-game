...
/**
 * Represents an easy AI player for Othello.
 */
public class FacileIA implements AIPlayer {

    /**
     * Evaluates the current state of the Othello board for the given player.
     * 
     * @param ob The current Othello board.
     * @param op The player for whom to evaluate the board.
     * @return The evaluation score.
     */
    private static int evaluate(OthelloBoard ob, OthelloPlayer op) {
        return ob.countWhite() - ob.countBlack();
    }
